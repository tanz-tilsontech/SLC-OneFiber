...
function verifyUser() {
  ...
  var owner = "tilson"
  if (sessionStorage.getItem("fulcrum_useremail").indexOf(customer) === -1 || sessionStorage.getItem("fulcrum_useremail").indexOf(owner) === -1 || sessionStorage.getItem("fulcrum_useremail") === null) {
