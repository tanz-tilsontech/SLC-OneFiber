...
function drawCharts() {
  // HUB COMPLETE
  $(function() {
    var result = alasql("SELECT hub AS label, COUNT(CASE WHEN cable_placement_total_footage_cx_final::NUMBER is null THEN 0 ELSE 1) AS total FROM ? GROUP BY hub", [features]);
